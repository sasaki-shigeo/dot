...
;; 	 ",japanese-jisx0208:-apple-甲仿幼用殘打 pro w4-medium-r-normal--14-140-75-75-m-140-jisx0208.1983-sjis" 
;; 	 ",katakana-jisx0201:-apple-甲仿幼用殘打 pro w4-medium-r-normal--14-140-75-75-m-140-jisx0201.1976-0"
...
(set-fontset-font "fontset-default"
                  'japanese-jisx0208
                  '("甲仿幼用殘打 pro w4*" . "jisx0208.*"))
(set-fontset-font "fontset-default"
                  'katakana-jisx0201
                  '("甲仿幼用殘打 pro w4*" . "jisx0201.*"))
...
(when (and (>= emacs-major-version 20)
  ...
  (cond ((featurep 'its)		; EGG4
	 ...
	 (define-its-state-machine-append its-hira-map
	   (its-defrule "Z,"  "﹜" nil t)
	   (its-defrule "wi"  "丹不" nil t)
	   (its-defrule "we"  "丹之" nil t)
	   (its-defrule "thi" "化不" nil t)
	   (its-defrule "twu" "午丰" nil t)
	   (its-defrule "thu" "化文" nil t)
	   (its-defrule "dhi" "匹不" nil t)
	   (its-defrule "dwu" "升丰" nil t)
	   (its-defrule "dhu" "匹文" nil t)))
	((featurep 'egg)
